...
public class GuitarString {
    ...
    public void pluck() {
        ...
        Deque<Double> randomNumbersBuffer = new LinkedListDeque<Double>();
        for (int i = 0; i < buffer.size(); i++) {
            double r = Math.random() - 0.5;
            randomNumbersBuffer.addLast(r);
        }
        buffer = randomNumbersBuffer;
    }
    ...
    public void tic() {
        ...
        double front0 = buffer.removeFirst();
        double front1 = buffer.get(0);
        double newDouble = DECAY * 0.5 * (front0 + front1);
